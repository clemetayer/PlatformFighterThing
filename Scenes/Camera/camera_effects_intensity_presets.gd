...
@export_group("FULL_SCREEN_EFFECTS")
@export_subgroup("CHROMATIC_ABERRATION")
@export var LOW_CHROMATIC_ABERRATION_STRENGTH := 0.0
@export var LOW_CHROMATIC_ABERRATION_DURATION_DIVIDER := 1.0
@export var MID_CHROMATIC_ABERRATION_STRENGTH := 0.0
@export var MID_CHROMATIC_ABERRATION_DURATION_DIVIDER := 1.0
@export var HIGH_CHROMATIC_ABERRATION_STRENGTH := 0.0
@export var HIGH_CHROMATIC_ABERRATION_DURATION_DIVIDER := 1.0
