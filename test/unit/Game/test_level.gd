...
func test_init_level_data():
	...
	level_data.level_path = "res://test/unit/Game/test_level_mocks/level.tscn"
	level_data.background_and_music = "res://test/unit/Game/test_level_mocks/background_and_music.tscn"
	# when
